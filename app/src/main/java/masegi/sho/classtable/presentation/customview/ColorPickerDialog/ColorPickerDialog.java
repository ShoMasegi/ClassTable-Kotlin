...
package masegi.sho.classtable.presentation.customview.ColorPickerDialog;
...
public class ColorPickerDialog extends DialogFragment implements ColorPickerSwatch.OnColorSelectedListener {
    ...
    protected ArrayList<Integer> mColorResIds = null;
    ...
    public static ColorPickerDialog newInstance(int mSelectionType, ArrayList<Integer> colorResIds,
            int columns, int size) {

        ColorPickerDialog ret = new ColorPickerDialog();
        ret.initialize(mSelectionType, colorResIds, columns, size);
        return ret;
    }

    public void initialize(int selectionType, ArrayList<Integer> colorResIds, int columns, int size) {

        mSelectedColor = new ArrayList<>();
        setArguments(selectionType, columns, size);
        setColors(colorResIds);
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        if (savedInstanceState != null) {
            mColorResIds = savedInstanceState.getIntegerArrayList(KEY_COLORS);
        }
    ...
    public void setColors(ArrayList<Integer> colorResIds) {
        if (mColorResIds != colorResIds) {
    ...
    private void refreshPalette() {
        if (mPalette != null && mColorResIds != null) {
            mPalette.drawPalette(mColorResIds, mSelectedColor);
        }
    }
    ...
    public void onSaveInstanceState(Bundle outState) {
        ...
        outState.putIntegerArrayList(KEY_COLORS, mColorResIds);
