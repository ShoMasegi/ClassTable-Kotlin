...
public class ColorPickerPalette extends TableLayout {
     ...
     */
    public void drawPalette(ArrayList<Integer> colorResIds, ArrayList<Integer> selectedColor) {
        if (colorResIds == null) {
            return;
        }
        ...
        for (int colorResId : colorResIds) {
            View colorSwatch = createColorSwatch(colorResId, selectedColor);
     ...
     */
    private ColorPickerSwatch createColorSwatch(int colorResId, ArrayList<Integer> selectedColor) {

        ColorPickerSwatch view = new ColorPickerSwatch(getContext(), colorResId,
                selectedColor.contains(colorResId), mOnColorSelectedListener);
